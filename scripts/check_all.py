...
def main() -> int:
    ...
    if task_graph.get("control_plane_policy") != {
        "schema_version": 1,
    ...
    for required_text in ("nearest AGENTS.md", "fast slice_check", "control concern"):
    ...
    for required_text in ("real repository diff", "integration_paths", "degraded-control finding"):
